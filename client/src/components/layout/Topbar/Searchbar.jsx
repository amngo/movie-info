...
const loadOptions = async inputValue => {
  ...
  return data.results.slice(0, 4).map(media => ({ value: media.id, label: media.title || media.name, type: media.media_type, image: media.poster_path || media.profile_path }));
};
...
const formatOptionLabel = props => {
  ...
  return (
    <div className='flex items-center'>
      <img src={props.image ? `https://image.tmdb.org/t/p/w500${props.image}` : image} alt='' className='w-8 mr-2' />
